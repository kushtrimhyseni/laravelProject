...
let PlayerMoves = {
  calcAttack: function(){
    ...
    let playerAttack = function(){
      ...
      let calcOuptutDamage = calcBaseDamage + offsetDamage;
      //Number of hits
      let numberOfHits = Math.floor(Math.random() * Math.floor(player.agility / 10) / 2) + 1;
      let attackValues = [calcOuptutDamage, numberOfHits];
      return attackValues;
    }
  ...
  let enemyAttack = function(){
   ...
   //Get player/enemy health !
    ...
    if (getPlayerSpeed >= getEnemySpeed){
        ...
        alert("You hit " +playerAttackValues[0] + " damage in " + playerAttackValues[1] + " times.");
        ...
        if (enemy.health <=0){
          ...
          alert("Enemy hit " + enemyAttackValues[0] + " damage in " + enemyAttackValues[1] + " times.");
